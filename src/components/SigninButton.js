...
export default function SigninButton() {
  ...
  const [openSnack, setOpenSnack] = React.useState(
    (auth.user === "user" && from.pathname === "/questions") || "/mange"
      ? true
      : false
  );
